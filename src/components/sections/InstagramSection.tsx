...
// Placeholder Instagram posts - will be replaced with real data later
    ...
    <section className="py-24 bg-white">
      <Container>
        <SectionHeading
          ...
          subtitle="Join our community on Instagram for daily updates, behind-the-scenes moments, and inspiration"
        />
